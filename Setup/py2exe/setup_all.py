...
py2exe_options = dict(
    ...
    includes = "throb", # AVI throb images
#    dll_excludes = "dapi.dll,mapi32.dll",
#    typelibs = [
#        ('{00062FFF-0000-0000-C000-000000000046}', 0, 9, 1),
...
#    company_name = "Alex Cherney",
#    copyright = "Alex Cherney (c)  2004",
#    comments = "Outlook Addin for ClamWin Antivirus",
#    modules = ["Addin"],
#    dest_base = "bin/OutlookAddin",
#    create_exe = False,
#)
...
tray = dict(
    ...
    icon_resources = [(1, "../../py/img/FrameIcon.ico")],
    script = os.path.join(sb_top_dir, "py", "Tray.py"),
    dest_base = "bin/Tray",
)
